...
*** Test Cases ***
Verify whether the Registered user is able to navigate to My Account sections successfully through chrome browser
...
Removing all Pets from Pet Profile Page
    ...
    Wait Until Element Is Visible   xpath=//A[text()='Add a New Pet']       20
...
Change My Store Validation
    ...
    Wait Until Element Is Visible   xpath=//h1[text()='Store Locator']      20
